        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
              ...
              <li class="active"><a href="kegiatan.php">News</a></li>
                  ...
                  <div class="blog-archive-left">
                    ...
                    <article class="blog-news-single">
                      <div class="blog-news-img">
                        <a href="blog-single-with-right-sidebar.php"><img src="<?php echo base_url('assets/images/Firebase.jpeg');?>"
                            alt="image"></a>
                      </div>
                    ...
                    <article class="blog-news-single">
                      <div class="blog-news-img">
                        <a href="blog-single-with-right-sidebar.php"><img src="<?php echo base_url('assets/images/blog-img-2.jpg');?>"
                            alt="image"></a>
                      </div>
                      <div class="blog-news-title">
                        <h2><a href="blog-single-with-right-sidebar.php">All about writing story</a></h2>
                    ...
                    <article class="blog-news-single">
                      <div class="blog-news-img">
                        <a href="blog-single-with-right-sidebar.php"><img src="<?php echo base_url('assets/images/blog-img-3.jpg');?>"
                            alt="image"></a>
                      </div>
                      <div class="blog-news-title">
                        <h2><a href="blog-single-with-right-sidebar.php">All about writing story</a></h2>
                   ...
                   <!-- <div class="sidebar-widget">
                    ...
                    <div class="sidebar-widget">
                      ...
                      <ul class="widget-archive">
                        <li><img src="<?php echo base_url('assets/images/berita.png');?>" width="80px" height="80px"></img> 
