              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="slide-article">
                    <h1 class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">Ketua Himpunan Mahasiswa
                      Jurusan Teknologi Informasi </h1>
                    <p class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.75s">Mega Silvia</p>
                    <a class="read-more-btn wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s" href="#">Read
                      More</a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
          ...
          <div class="slide-content">
            <div class="container">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="slide-article">
                    <h1 class="wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.5s">Wakil Ketua Himpunan
                      Mahasiswa Jurusan Teknologi Informasi</h1>
